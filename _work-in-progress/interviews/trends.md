...
**Data:** In-person interview components rose from ~24% (2022) to ~38% (2025), with continued growth in 2026.
...
**Shift:** Traditional LeetCode alone is no longer sufficient.
...
**Question trend:** "What's your favorite prompt?" and "What have you built with AI?" now common.
...
**Fundamental shift:** Companies assume anyone can build a chatbot. They hire for people who can *measure* one.
...
**Assignment trend:** "Multi-Agent Workflow Orchestrator" tasks replacing single-agent demos.

### 2.3 Evaluation as a First-Class Concern

**Why:** Production AI failures are expensive and visible.
...
### 2.4 Cost & Latency Awareness

**New baseline expectation:** Candidates must discuss token economics.
...
**Data:** 93% of AI Engineering roles require skills beyond pure GenAI.
...
**Trend:** Pure "LLM API caller" roles disappearing. AI Engineers must be full-stack capable.
...
**Trend:** Companies open-sourcing their take-home assignments for branding.
...
**Benefit:** Attracts candidates who want to see the quality of problems they'll work on.
...
**Quality > quantity:** Single impressive project beats multiple tutorial clones.
...
**Self-taught trend:** More candidates entering via AI without formal ML background.
...
4. **AI interviewer ethics:** Proctoding by AI needs transparency.
