...
- [Interview Process Analysis](interview-process.md) - common patterns, step counts, time estimates, AI use in hiring, and key takeaways
...
- 20+ companies use AI in their own hiring; 6 ban candidates from using AI during interviews
